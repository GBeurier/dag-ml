...
| Bundle/replay | bundle matches execution plan fingerprints, refit artifacts match node plans, typed prediction requirements and cache manifests match OOF edges, replay envelopes match data requirements, unsupported bundle schema version refused |
