...
| CLI contracts | selection command, bundle build command, mock/process refit bundle capture, bundle validation with replay request and data envelope, mock replay execution, process adapter campaign/replay execution, persistent JSONL process campaign, stateful sklearn refit/replay |
