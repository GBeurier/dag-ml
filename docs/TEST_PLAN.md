...
| ABI | null pointer handling, invalid JSON, valid graph, grouped selection output, bundle/replay validation, prediction-cache payload validation, data-provider vtable routing, prediction-cache vtable routing, mock replay execution summary |
