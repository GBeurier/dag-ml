...
| Selection | deterministic metric ranking, stable tie-breaking, grouped branch selection, identity-aligned regression metric reports over sample/target/group prediction blocks, CLI scoring to `CandidateScore`, sklearn demo merge selection |
