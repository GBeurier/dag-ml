...
| Policy | split unit, aggregation defaults, observation split guard, supervised selection fit scope, sample-augmentation unsafe flags, supervised selection mask audit, shape-delta fingerprint changes |
