...
des contrôleurs `n4m` PLS, `stats::lm`, `ranger`, `glmnet`, `parsnip` régression et un MLP CPU
...
neuf contrôles verts ; le paquet R `0.4.0.9008` a passé localement les tests
