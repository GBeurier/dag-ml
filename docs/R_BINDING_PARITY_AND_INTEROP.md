...
| `nirs4allformats` R 0.2.7 | Avancé | Lecture native, probe, records, dataset, parcours, bytes et sidecars. | Ce n'est pas encore un chemin direct vers un provider DAG-ML R prêt à entraîner. |
