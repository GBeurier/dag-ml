...
cargo run -p dag-ml-cli -- run-process-dsl-cv-refit-bundle --dsl examples/pipeline_dsl_branch_merge_executable.json --controllers examples/controller_manifests.json --envelope examples/fixtures/data/coordinator_data_plan_envelope_sample12.json --adapter examples/adapters/python_process_controller.py --persistent --process-workers 2 --bundle-id bundle:generated.dsl.branch.merge.cv.refit --selections examples/fixtures/bundle/selection_decisions_branch_merge.json --output examples/generated/execution_bundle_dsl_branch_merge_cv_refit.json --lineage-output examples/generated/lineage_dsl_branch_merge_cv_refit.json --prediction-cache-output examples/generated/prediction_cache_dsl_branch_merge_cv_refit.json --plan-id plan:generated.dsl.branch.merge.cv.refit
cargo run -p dag-ml-cli -- run-process-dsl-cv-refit-bundle --dsl examples/pipeline_dsl_tuner_executable.json --controllers examples/controller_manifests_alias_registry.json --envelope examples/fixtures/data/coordinator_data_plan_envelope_sample12.json --adapter examples/adapters/python_process_controller.py --persistent --process-workers 2 --bundle-id bundle:generated.dsl.tuner.alias.cv.refit --output examples/generated/execution_bundle_dsl_tuner_alias_cv_refit.json --lineage-output examples/generated/lineage_dsl_tuner_alias_cv_refit.json --prediction-cache-output examples/generated/prediction_cache_dsl_tuner_alias_cv_refit.json --plan-id plan:generated.dsl.tuner.alias.cv.refit
...
cargo run -p dag-ml-cli -- run-process-dsl-cv-refit-replay --dsl examples/pipeline_dsl_branch_merge_executable.json --controllers examples/controller_manifests.json --envelope examples/fixtures/data/coordinator_data_plan_envelope_sample12.json --adapter examples/adapters/sklearn_process_controller.py --process-workers 2 --bundle-id bundle:cli.dsl.branch.merge.sklearn.cv.refit.replay --selections examples/fixtures/bundle/selection_decisions_branch_merge.json --plan-id plan:cli.dsl.branch.merge.sklearn.cv.refit.replay
...
blocks, coordinator-owned lineage records with branch-to-merge dependencies,
portable process-adapter artifact refs, and persisted branch/merge selection
decisions. The paired predict
...
`validate-artifact-manifest` and `validate-bundle --artifact-manifest` reopen and
