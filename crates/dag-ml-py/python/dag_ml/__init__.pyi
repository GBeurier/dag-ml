...
class MethodsTerminalPredictionReceipt:
    @property
...
class MethodsTerminalPredictionResult:
    ...
    portable_predictor_package_json: str
    terminal_prediction: dict[str, Any]
    terminal_prediction_json: str
...
def read_native_results_v2_json(run_dir: str) -> str: ...
def write_native_results_v2_json(
    run_dir: str,
    manifest_json: str,
    score_set_json: str,
...
def select_portable_output_json(package_json: str, binding_id: str) -> str: ...
...
def select_candidate_json(policy_json: str, candidates_json: str) -> str: ...
