...
use dag_ml_core::{InitialFullRefitPackage, PredictCohort, PredictCohortRole, SampleRelationSet};
...
unsafe extern "C" fn invoke(
    ...
    if task["phase"] == "PREDICT" {
        ...
        result["lineage"]["record_id"] = json!("lineage:cabi.initial.predict");
        result["predictions"][0]["prediction_id"] = json!("pred:cabi.initial.predict");
